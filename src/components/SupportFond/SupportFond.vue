<template>
  <div class="SupportFond">
    <div class="page">
      <h3 class="SupportFond__title">
        Поддержите наш Фонд, который способствует развитию талантов и укреплению
        культурных ценностей в обществе
      </h3>

      <p class="SupportFond__description">
