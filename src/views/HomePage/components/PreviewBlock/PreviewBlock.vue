  ...
  <div class='PreviewBlock'>
    ...
    <div class="page">
      <div class="PreviewBlock__preview">
        <div class="PreviewBlock__preview-item PreviewBlock__preview-item--left">
          <NavigationMain/>
          <img class="PreviewBlock__preview-image" src="/images/first.jpg"/>
        </div>

        <section class="PreviewBlock__preview-item PreviewBlock__preview-item--center">
          <h2 class="PreviewBlock__preview-center-title">ФОНД «КРАСНЫЙ ДРАКОН»</h2>
