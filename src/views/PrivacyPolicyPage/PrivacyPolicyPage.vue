<template>
  <div class="PrivacyPolicyPage page">
    ...
    <p>
      ...
      персональных данных, предпринимаемые фондом развития инфраструктурных
      проектов, спорта и молодежных движений "КРАСНЫЙ ДРАКОН" (далее —
      Оператор).
    </p>
    <p>
    ...
    <p>
      ...
      <a href="https://red-dragon.pro/" target="_blank"
        >https://red-dragon.pro/</a
      >.
    </p>
    ...
    <ul>
      ...
      <li>
        ...
        уведомления на адрес электронной почты Оператора reddragonfond@mail.ru с
      ...
      <li>
        8.5. Пользователь может в любой момент отозвать свое согласие на
        обработку персональных данных, направив Оператору уведомление
        посредством электронной почты на электронный адрес Оператора
        reddragonfond@mail.ru с пометкой «Отзыв согласия на обработку
        персональных данных».
      </li>
      <li>
        8.6. Вся информация, которая собирается сторонними сервисами, в том
        ...
        конфиденциальности. Субъект персональных данных обязуется самостоятельно
        ознакомиться с указанными документами.
      </li>
      <li>
        8.7. Установленные субъектом персональных данных запреты на передачу
      ...
      <li>
        8.8. Оператор при обработке персональных данных обеспечивает
        конфиденциальность персональных данных.
      </li>
      <li>
        8.9. Оператор осуществляет хранение персональных данных в форме,
      ...
      <li>
        8.10. Условием прекращения обработки персональных данных может являться
    ...
    <ul>
      <li>
        ...
        Оператору с помощью электронной почты reddragonfond@mail.ru.
      </li>
      <li>
      ...
      <li>
        ...
        Интернет по адресу
        <a href="https://red-dragon.pro/privacy-policy" target="_blank"
          >https://red-dragon.pro/privacy-policy</a
        >.
      </li>
    </ul>
  </div>
